...
<div class="dropdown">
		...
		<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
			@if (app()->getLocale() == 'en')
				<span class="symbol symbol-20 mr-3">
					<img src="{{ asset('backend_assets/assets/media/svg/flags/226-united-states.svg') }}" alt="">
				</span>
				@else
				<span class="symbol symbol-20 mr-3">
					<img src="{{ asset('backend_assets/assets/media/svg/flags/008-saudi-arabia.svg') }}" alt="">
				</span>
			@endif
	...
	<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right " style="">
		...
		<ul class="navi navi-hover py-4">
			<!--begin::Item-->
			<li class="navi-item">
				<a href="{{route('locale.change',['lang' => 'en'])}}" class="navi-link {{ app()->getLocale() == 'en' ? 'active' : '' }}">
					<span class="symbol symbol-20 mr-3 " >
						<img src="{{ asset('backend_assets/assets/media/svg/flags/226-united-states.svg') }}" alt="">
					</span>
			...
			<li class="navi-item">
				<a href="{{route('locale.change',['lang' => 'ar'])}}" class="navi-link {{ app()->getLocale() == 'ar' ? 'active' : '' }}">
					<span class="symbol symbol-20 mr-3 ">
						<img src="{{ asset('backend_assets/assets/media/svg/flags/008-saudi-arabia.svg') }}" alt="">
					</span>
