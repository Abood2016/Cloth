                ...
                <div class="col-lg-10 col-md-12 col-lg-offset-1">
                    <div class="ps-product__thumbnail">
                        ...
                        <div class="ps-product__image">
                            @foreach ($product->media as $image)
                                <div class="item">
                                    <img class="zoom" src="{{ asset('images/products/' . $image->image_name) }}"
                                        alt="" data-zoom-image="{{ asset('images/products/' . $image->image_name) }}">
                                </div>
                            @endforeach
                    ...
                    <div class="ps-product__thumbnail--mobile">
                        <div class="ps-product__main-img"><img
                                src="{{ asset('images/products/cover_image/' . $product->image) }}" alt=""></div>
              ...
              <select class="ps-rating">
                ...
                <option value="2">5</option>
                        ...
                        <div class="ps-product__shopping">
                            ...
                            <a class="ps-btn mb-10" href="#" id="add-to-cart">Add
                                to cart<i class="ps-icon-next"></i>
                            </a>
