    ...
    <div class="col-sm-12">
        <form method="post" action="{{ route('users.store') }}" class="ajaxForm">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input class="form-control" autofocus style="text-align: center" type="text" id="name" name="name"
                        autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label class="col-3 col-form-label">إسم المستخدم :</label>
                <div class="col-8">
                    <input class="form-control" autofocus style="text-align: center" type="text" id="username"
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input class="form-control" autofocus style="text-align: center" type="text" id="email"
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input class="form-control" autofocus style="text-align: center" type="password"
